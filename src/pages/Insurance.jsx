...
function InsuranceForm({ open, onClose, record, vehicles }) {
  ...
  const mutation = useMutation({
    mutationFn: (d) => isEdit ? base44.entities.InsurancePolicy.update(record.id, d) : base44.entities.InsurancePolicy.create(d),
    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ['insurances'] }); onClose(); }
  });

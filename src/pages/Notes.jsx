...
import { StickyNote, Pencil, Trash2, MoreVertical, CheckCircle, Circle, Calendar, Search, X } from 'lucide-react';
...
export default function Notes() {
  ...
  const filtered = (() => {
    let result = vehicleFilter === 'all' ? notes : notes.filter(n => n.vehicle_id === vehicleFilter);
    if (searchQuery.trim()) {
